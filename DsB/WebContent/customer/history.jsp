...
<body>
	...
	<div class="container-fluid">
		<div class="row">
			...
			<div class="tab">
  <button class="tablinks" onclick="window.location.href='${pageContext.request.contextPath}/customer/customer.jsp'">Catalogue</button>
  <button class="tablinks" onclick="')">Search</button>
  <button class="tablinks" onclick="window.location.href='${pageContext.request.contextPath}/customer/history.jsp'">History</button>
</div>
